                        ...
                        <div class="btn-group dropdown">
                            <a href="#" class="btn btn-sm btn-outline-primary dropdown-toggle" data-bs-toggle="dropdown">Change Role</a>
                                ...
                                <div class="dropdown-menu dropdown-menu-dark">
                                    <a href="_actions/role.php?id=<?= $user->id ?>&role=1" class="dropdown-item">Guest</a>
                            ...
                            <?php else : ?>
                                <a href="_actions/suspended.php?id=<?= $user->id ?>" class="btn btn-sm btn-outline-success">Active</a>
                            <?php endif ?>
